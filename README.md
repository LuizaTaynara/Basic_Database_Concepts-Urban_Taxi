...
### Objective
Perform investigation and validation activities using command-line tools and SQL queries to analyze application logs, identify system issues, and validate business data stored in a relational database.
...
### Artifacts Produced
#### ✔️ SQL Queries
- [**Database**](https://docs.google.com/document/d/1BVC68LdmsQyUm7KKB5O6zx_HCmU1ltMkvZXpqOr8xCA/edit?usp=sharing)
